class CommitteesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @committee.save
        format.html { redirect_to committees_url, notice: 'Gremium erstellt.' }
  ...
  def update
    respond_to do |format|
      if @committee.update(committee_params)
        format.html { redirect_to committees_url, notice: 'Gremium aktualisiert.' }
  ...
  def destroy
    @committee.destroy
    respond_to do |format|
      format.html { redirect_to committees_url, notice: 'Gremium gelöscht.' }
